...
export default function Nav() {
  return (
    // Starter code taken from Nav example on Tailwind UI components
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 w-full">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2  neoBorder hover:bg-pink hover:font-bold focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'font-semibold' :' hover:font-medium',
              ...
              {/* Dark <-> light mode button - In Progress*/}
